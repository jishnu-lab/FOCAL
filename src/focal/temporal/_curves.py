...
from focal.backends.dictys._stats import lcpm_tf
from focal.temporal._forces import calculate_force_curves as _calculate_force_curves
from focal.utils.genes import get_gene_indices, get_tf_indices
import matplotlib
...
class SmoothedCurvesGRN:
    ...
    def calculate_force_curves(
        ...
        :func:`focal.temporal._forces.calculate_force_curves` (ISSUES.md #23).
