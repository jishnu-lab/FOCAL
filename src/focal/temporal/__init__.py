"""**FocalTemporal** -- how TF regulation changes along a trajectory.
...
from focal.temporal._align import AlignTimeScales, plot_main_trajectory_nodes
from focal.temporal._chromatin import (
    SmoothedCurvesChromatin,
    plot_chromatin_tf_dynamics,
    plot_score_vs_count_subplots,
)
from focal.temporal._curves import (
    SmoothedCurvesGRN,
...
from focal.temporal._episodes import (
    EpisodeDynamics,
...
from focal.temporal._source import TFForceSource
from focal.temporal._reductions import (
    abs_max_force,
    mean_force,
    softmax_peak,
)
from focal.temporal._phases import (
    BindingPhases,
    ForceWavePhases,
    RegulatoryPhases,
...
from focal.temporal._states import (
    StateFrequency,
    plot_state_composition_bars,
    plot_state_composition_curves,
    plot_state_extrema,
)
from focal.temporal._validation import (
    TFForceValidation,
...
from focal.temporal._waves import (
    TFForceWaves,
    cluster_heatmap,
    plot_force_by_tf,
    plot_force_heatmap,
...
from focal.temporal.manager import (
    TemporalManager,
    TrajectorySegments,
