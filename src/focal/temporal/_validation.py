"""Validation of enriched (Focal) links against size-matched random links.
...
comes from :mod:`focal.temporal._phases`.
"""
...
from focal.temporal._phases import RegulatoryPhases
from focal.temporal._waves import TFForceWaves
import matplotlib.pyplot as plt
from focal.temporal._phases import _PHASE_ROMAN
...
class TFForceValidation:
    """Validate enriched (Focal) links against size-matched random links by
...
def plot_force_validation_boxes(df, figsize=(5, 6), ylabel='Abs max TF force',
    ...
    groups = [('enriched', 'Enriched (Focal)'),
