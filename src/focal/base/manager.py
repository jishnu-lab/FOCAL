"""The behaviour every Focal module manager shares.

A manager is the entry point of a Focal module. It *composes* domain objects
...
class BaseManager:
    """Shared bookkeeping for :class:`~focal.temporal.TemporalManager` and friends.
